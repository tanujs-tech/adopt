import {
  ...
  CREATE_PET_AND_ADOPTION_REQUEST_SUCCESS,
  CREATE_PET_AND_ADOPTION_REQUEST_FAILURE
} from '../actions/pet';
...
const pet = (state = initialState, action) => {
  switch (action.type) {
    ...
    case CREATE_PET_AND_ADOPTION_REQUEST:
      return Object.assign({}, state, {
        isFetching: true,
      });
    case CREATE_PET_AND_ADOPTION_REQUEST_SUCCESS:
      return Object.assign({}, state, {
        isFetching: false,
      });
    case CREATE_PET_AND_ADOPTION_REQUEST_FAILURE:
      return Object.assign({}, state, {
        isFetching: false,
        error: action.error
      })
